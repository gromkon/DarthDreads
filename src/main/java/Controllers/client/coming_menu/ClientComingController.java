package Controllers.client.coming_menu;
...
public class ClientComingController extends ClientController implements Initializable {

    public Label comingLbl;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        comingLbl.setText(DB.getClientVisitsLater(ui.getMail(), date));
    }
}
