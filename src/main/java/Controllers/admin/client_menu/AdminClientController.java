package Controllers.admin.client_menu;
...
public class AdminClientController extends AdminController implements Initializable {
    ...
    public void addNewClient(ActionEvent actionEvent) {
        SceneController.changeScene((Stage) addNewClientBtn.getScene().getWindow(), "Админ_Клиенты_Добавить");
    }
    ...
    public void changeClient(ActionEvent actionEvent) {
        ...
        if (c != null) {
            ...
            SceneController.changeScene((Stage) changeClientBtn.getScene().getWindow(), "Админ_Клиенты_Редактировать");
        }
    }
